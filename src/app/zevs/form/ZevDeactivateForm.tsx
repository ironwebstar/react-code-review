...
import { validateZevDeactivate } from "./ZevDeactivateForm.Validation"

interface ZevDeactivateFormProps {
  open: boolean
  onClose: () => void
...
export const ZevDeactivateForm = (props: ZevDeactivateFormProps) => {
  const { t } = useTranslation("zevs")
  const { open, onClose, confirmClick, zevStartDate } = props
  return (
